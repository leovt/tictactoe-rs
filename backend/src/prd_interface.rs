...
use common::{Game, Player, Position};
...
#[get("/games")]
pub fn list_games(games: &State<Games>) -> Template {
...
#[get("/games/<id>")]
pub fn game(id: String, games: &State<Games>) -> Template {
    ...
    Template::render(
        "game",
        context! {board: board, status: game.status_message()},
    )
}
